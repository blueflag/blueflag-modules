...
function Coverage(program) {
    ...
    var args = ['--all', '--check-coverage', '--branches=' + minCoverage, '--functions=' + minCoverage, '--lines=' + minCoverage, '--statements=' + minCoverage, '--include=src/**', '--exclude=**/*-test.js', '--reporter=text', '--reporter=lcov', '--extension=.jsx', '--extension=.js', blueflagTestBin, 'test'];
